import type { DevtoolsPluginApi } from '@vue/devtools-api/lib/esm/api/index.js';
import type { PluginDescriptor, ExtractSettingsTypes, PluginSettingsItem } from '@vue/devtools-api/lib/esm/plugin.js';
export * from '@vue/devtools-api/lib/esm/api/index.js';
export * from '@vue/devtools-api/lib/esm/plugin.js';
export * from '@vue/devtools-api/lib/esm/time.js';
export { PluginQueueItem } from '@vue/devtools-api/lib/esm/env.js';
