import type { ComponentTreeNode, InspectedComponentData, ComponentInstance, ComponentDevtoolsOptions } from '@vue/devtools-api/lib/esm/api/component.js';
import type { App } from '@vue/devtools-api/lib/esm/api/app.js';
import type { CustomInspectorNode, CustomInspectorState, TimelineEvent } from '@vue/devtools-api/lib/esm/api/api.js';
